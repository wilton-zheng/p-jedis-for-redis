...
public class JedisTest {
	private static final String HOST = "127.0.0.1"; // redis主机地址
	...
	public void testKey() throws InterruptedException {
		...
		System.out.println("新增<'username','LingDu'>的键值对：" + jedis.set("username", "LingDu"));
	...
	public void testString() {
        ...
        try {
			TimeUnit.SECONDS.sleep(3);//由于上面设置了有效时间为2秒，这里休眠3秒后已经超过有效时间了，后面再通过Key获取值的时候值为NULL
	...
	public void testSet(){
        ...
        System.out.println(jedis.sadd("eleSet", "e6"));//添加的时候检查重复，重复则不添加
	...
	public void testSort()
    {
        ...
        jedis.hset("user:11", "city", "beijing");  
        jedis.hset("user:22", "city", "shanghai");  
        jedis.hset("user:33", "city", "guangzhou");  
        jedis.hset("user:55", "city", "chongqing");  
        jedis.hset("user:66", "city", "xi'an");  
        sortingParameters = new SortingParams();
        sortingParameters.get("user:*->name");  
        sortingParameters.get("user:*->city"); 
